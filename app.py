...
# ══════════════════════════════════════════════════════════
    ...
    if df is None:
        ...
        st.caption(
            "另跑一條 OLS（住房率 ~ 星等＋縣市＋房間數＋月份＋客源結構，標準誤依旅館 cluster）："
            "控制後有星等偏效果約 +12 pp（原始 +16.8 pp；95% CI 依旅館 cluster 約 1–21 pp），"
            "其中三、四星縮到 +7~10 pp、五星幾乎不動（約 +19.6 pp）——星等本身仍有實質關聯，但仍為觀察性結果、非因果。"
        )
